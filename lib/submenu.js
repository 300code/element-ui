...
/* harmony default export */ var submenuvue_type_script_lang_js = ({
  ...
  render: function render(h) {
    ...
    console.log('hideArrow:', hideArrow, 'mode:', rootMenu.mode);
    ...
    var submenuTitleIcon = hideArrow ? null : rootMenu.mode === 'horizontal' && isFirstLevel || rootMenu.mode === 'vertical' && !rootMenu.collapse ? 'el-icon-arrow-down' : 'el-icon-arrow-right';
    ...
    return h(
      ...
      [h(
        ...
        [$slots.title, submenuTitleIcon && h('i', { 'class': ['el-submenu__icon-arrow', submenuTitleIcon] })]
